...
This Project 05 variant demonstrates the generator plus evaluator pattern for
...
3. Read `evaluator-rubric.md` to understand this variant's revision evidence.
