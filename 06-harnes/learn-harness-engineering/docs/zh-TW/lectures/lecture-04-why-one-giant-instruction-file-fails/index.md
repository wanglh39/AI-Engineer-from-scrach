...
**中間迷失。** 「Lost in the Middle」這篇論文（Liu et al., 2023）清楚地證明了：LLM 對長文字中間部分的資訊利用效率顯著低於兩端。你的 AGENTS.md 有 600 行，第 300 行寫的是「所有資料庫查詢必須用參數化查詢」，這是安全硬約束。但它被埋在中間，agent 幾乎一定會忽略它。
